...
class MainMenuState extends MusicBeatState
{
	...
	public static var vibeEngineVersion = Std.string(Application.current.meta.get('version'));
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "v" + vibeEngineVersion, 12);
